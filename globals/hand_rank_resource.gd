...
@export var hand_rank_type: HandRankType = HandRankType.HIGH_DICE
@export var base_multiplier: float = 1.0 # 기본 배수
@export var max_multiplier: float = 3.0  # 최대 배수
@export var base_chips: int = 0          # Hand Rank 고유 chips (패턴 복잡도 반영, 주사위 값에 가산)
